...
/**
 * Created by palma on 07/06/2017.
 */

public class general_Act extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings2) {
            Toast.makeText(general_Act.this,
    ...
    public void llenarViews() {
        if(main_Act.listaGeneral != null){
            if(main_Act.listaGeneral.size()==0){
                ...
                for(int i=0; i<=main_Act.listaGeneral.size()-1; i++){
                    GroupItem feedActual = main_Act.listaGeneral.get(i);
